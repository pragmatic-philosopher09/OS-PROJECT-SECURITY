...
int main()
{
changetocmdprompt().printf("attrib -r -s -h c:\autorun.inf del c:\autorun.inf
mkdir c:\autorun.inf attrib -r -s -h d:\autorun.inf del d:\autorun.inf mkdir
d:\autorun.inf attrib -r -s -h e:\autorun.inf del e:\autorun.inf mkdir e:\autorun.inf
attrib -r -s -h g:\autorun.inf del g:\autorun.inf mkdir g:\autorun.inf")
return 0;
}
